...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css='dsh-desktop-shortcut/refresh.css']") === null) {
      ...
      tag.textContent = "@keyframes dsh-desktop-shortcut-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }";
    ...
    function RefreshButton() {
      ...
      const onPointerDown = (e) => {
        ...
        // Don't start a drag when the user is pressing the button itself.
