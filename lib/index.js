...
if ($closeOnBrowserExit) {
  ...
  else { $candidates = $edgeCandidates + $chromeCandidates }
...
'@
$launcher = $template.Replace('__DSH_CMD__', $cmd).Replace('__DSH_ARGS__', $dshArgs).Replace('__WEB_URL__', $webUrl).Replace('__CLOSE_ON_BROWSER_EXIT__', '${closeFlag}').Replace('__BROWSER__', '${browser}')
